...
model = dict(
    ...
    auxiliary_head=dict(in_channels=512, num_classes=19, loss_decode=main_loss),
    test_cfg=dict(mode='whole', crop_size=crop_size, stride=(426, 426), multi_label=True),
)
...
work_dir = './work_dirs/upernet_convnext_base_fp16_640x640_80k_multi_all_lovasz'
